        ...
        <div class="row px-4 py-4">
            ...
            <div class="card h-100 product-card <?php if ($highlight_id == $row['id']) echo 'border border-warning border-3'; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!$delete_mode): ?>
                          <a href="oneplusbud.php?add_to_cart=<?php echo (int)$row['id']; ?>" class="btn btn-info">Add to Cart</a>
                          <a href="oneplusbud.php?add_to_cart=<?php echo (int)$row['id']; ?>&buy_now=1" class="btn btn-success">Buy Now</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
