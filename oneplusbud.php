...
<nav class="navbar navbar-expand-lg navbar-light d-none d-lg-flex">
  <div class="container-fluid">
    ...
    <a href="home.php" class="nav-glow">
      <img src="image/logo.png" width="45" alt="Logo">
    </a>
    ...
    <div class="collapse navbar-collapse show">
      ...
      <div class="d-flex align-items-center">
        <a class="nav-link nav-glow me-2" href="complain.php">📮 Complain List</a>
...
<nav class="navbar bg-info d-flex d-lg-none px-3">
  <div class="dropdown">
    <a class="btn text-dark fw-bold nav-glow dropdown-custom" href="#" role="button" data-bs-toggle="dropdown">
      <?php if (!empty($profile_image)): ?>
        <img src="uploads/<?php echo htmlspecialchars($profile_image); ?>" class="profile-img" alt="Profile">
      <?php else: ?>
  ...
  <div class="container-fluid justify-content-center">
    <ul class="navbar-nav products-section_2nav">
      ...
      <li class="nav-item dropdown mx-3 profile-desktop">
        <a class="nav-link nav-glow fw-bold" href="#" role="button" data-bs-toggle="dropdown">
          <?php if (!empty($profile_image)): ?>
            <img src="uploads/<?php echo htmlspecialchars($profile_image); ?>" class="profile-img" alt="Profile">
          <?php else: ?>
            <div class="nav-avatar">
      ...
      <li class="nav-item dropdown mx-3">
        <a class="nav-link dropdown-toggle nav-glow fw-bold" href="#" role="button" data-bs-toggle="dropdown">
          Mobiles
        </a>
        <ul class="dropdown-menu dropdown-glass">
          <li><a class="dropdown-item nav-glow" href="<?php echo $delete_mode ? 'apple.php?delete_mode=1' : 'apple.php'; ?>">Apple</a></li>
          <li><a class="dropdown-item nav-glow" href="<?php echo $delete_mode ? 'samsung.php?delete_mode=1' : 'samsung.php'; ?>">Samsung</a></li>
          <li><a class="dropdown-item nav-glow" href="<?php echo $delete_mode ? 'xiaomi.php?delete_mode=1' : 'xiaomi.php'; ?>">Xiaomi</a></li>
    ...
    <form id="bulkDeleteForm" method="POST" action="delete_selected_products.php">
      ...
      <div class="d-flex justify-content-between align-items-center bg-light p-3 rounded shadow-sm">
        ...
        <div class="d-flex gap-2">
          ...
          <button type="submit" id="deleteSelectedBtn" class="btn btn-danger btn-sm" style="display:none;" onclick="return confirm('Are you sure you want to delete selected products?');">
            Delete Selected
          </button>
        </div>
      </div>
          ...
          <div class="card-body products-section">
            ...
            <p class="card-text">
              <span id="short_<?php echo $row['id']; ?>">
                <?php echo $shortDesc; ?>...
                <a href="javascript:void(0);" onclick="toggleDesc(<?php echo $row['id']; ?>)" style="color:blue; font-weight:bold;">More</a>
              </span>

              <span id="full_<?php echo $row['id']; ?>" style="display:none;">
                <?php echo $fullDesc; ?>
                <a href="javascript:void(0);" onclick="toggleDesc(<?php echo $row['id']; ?>)" style="color:red; font-weight:bold;">Less</a>
              </span>
            </p>

            <h4 class="price-glow">₹<?php echo number_format($row['price']); ?></h4>
            <h6>
            ...
            <?php if (!$delete_mode): ?>
              <a href="oneplusbud.php?add_to_cart=<?php echo (int)$row['id']; ?>" class="btn btn-info btn-hover">Add to Cart</a>
              <a href="oneplusbud.php?add_to_cart=<?php echo (int)$row['id']; ?>&buy_now=1" class="btn btn-success btn-hover">Buy Now</a>
            <?php endif; ?>
          </div>
