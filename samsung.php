...
if (isset($_GET['add_to_cart'])) {
    $product_id = 'samsung_' . $_GET['add_to_cart'];
  
    if (isset($_SESSION['cart'][$product_id])) {
        $_SESSION['cart'][$product_id]['quantity'] += 1;
    } else {
        $raw_id = str_replace('samsung_', '', $product_id);
        $stmt = $conn->prepare("SELECT * FROM sum_products WHERE id = ?");
    ...
    if (isset($_GET['buy_now']) && $_GET['buy_now'] == 1) {
        ...
        header("Location: samsung.php"); // Add to cart → stay on home
    }
    exit();
  }
?>
...
<head>
    <meta charset="UTF-8">
    <title>Online Super Market - Sumsung</title>
...
<div class="row px-1">
    <div class="col-md-10 px-3">
        <div class="row px-4 py-4">
            <?php
          $query = "SELECT * FROM sum_products WHERE brand = 'samsung'";
          ...
          <div class="col-md-3 mb-4">
              <div class="card h-100 product-card<?php if ($highlight_id == $row['id']) echo 'border border-warning border-3'; ?>">
                  ...
                  <div class="card-body">
                      ...
                      <a href="samsung.php?add_to_cart=<?php echo $row['id']; ?>" class="btn btn-info">Add to Cart</a>
                      <a href="samsung.php?add_to_cart=<?php echo $row['id']; ?>&buy_now=1" class="btn btn-success">Buy Now</a>
                  </div>
              </div>
          </div>
          <?php endwhile; ?>
    ...
    <div class="col-md-2 bg-secondary p-0">
        <ul class="navbar-nav text-center">
            ...
            <!-- <li class="nav-item"><a href="#" class="nav-link text-light"><h5>Others</h5></a></li> -->
        </ul>
        <ul class="navbar-nav text-center">
